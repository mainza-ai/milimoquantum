...
BASE_URL = "" # Disabled for Milimo Quantum local data
MAX_SHARD = 0 # Only using shard_00000 and shard_06542
VAL_SHARD = MAX_SHARD
...
if __name__ == "__main__":
    ...
    print()
    # download_data(num_shards, download_workers=args.download_workers) # DISABLED FOR MILIMO
    print("Local Data Mode Enabled.")
    print()
    train_tokenizer()
    print()
